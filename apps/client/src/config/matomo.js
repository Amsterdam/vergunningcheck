...
export const actions = {
  ...
  CONCLUSIE_OUTCOME: "conclusie uitkomst",
  DOWNLOAD: "download",
...
export const eventNames = {
  ...
  BACK: "terug naar",
  CONTACT_CONCLUSION: "conclusie neem contact op",
