...
export default () => (
  <Intro
    ...
    usableForText={`U kunt deze vergunningcheck gebruiken als u een nieuwe zonwering, rolhek,
      rolluik of luik plaatst of als u een bestaande vernieuwt.`}
    exceptions={[
      "Het aantal woningen verandert.",
      `Het deel van het gebouw waarin de zonwering, het rolhek, rolluik of luik komt,
      is zonder vergunning gebouwd.`,
    ]}
  />
);
